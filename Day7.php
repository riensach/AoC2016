...
foreach($puzzleRows as $rowID => $rowValues) {
    ...
    foreach($matches as $matchID => $matchData) {
        ...
        $charList = new SplDoublyLinkedList();
        if(substr($matchData, 0, 1)=='[' && substr($matchData, -1, 1)==']') {
            ...
            foreach($characters as $charID => $char) {                
                ...
                if($charID>2 && $charList->offsetGet(0)==$charList->offsetGet(3) && $charList->offsetGet(1)==$charList->offsetGet(2) && $charList->offsetGet(0)<>$charList->offsetGet(1)) {
                    $invalid = 1;
                }
            }
        } else {
