...
for($c=0;$c<=50;$c++) {
    for($r=0;$r<=50;$r++) {
        ...
        ob_flush();
            ...
            $foundPath = findPath($cavernArrayMap, new Algorithms\ShortestPath\AStar($distance, $heuristic));
            if(is_array($foundPath)) {
                $possibleTargets[] = array_merge($foundPath[0],array('targetRow' =>$c,'targetColumn' =>$r));
            }
        }
